"""
Django settings for patient_glitter_dev_90478 project.
...
ROOT_URLCONF = 'patient_glitter_dev_90478.urls'
...
WSGI_APPLICATION = 'patient_glitter_dev_90478.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_glitter_dev_90478 API",
    "DESCRIPTION": "API documentation for patient_glitter_dev_90478 App",
    "VERSION": "v1",
}
