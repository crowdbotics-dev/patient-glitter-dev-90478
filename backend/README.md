...
## Project Structure
    ...
    ├── patient_glitter_dev_90478  # Django project configurations
...
1. Clone this repo and `cd patient_glitter_dev_90478`
...
2. Clone this repo and `cd patient_glitter_dev_90478`
